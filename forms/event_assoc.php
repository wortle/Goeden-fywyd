...
$title = "gettext(Associate Event to Person) #$person";

require "./header.php";

echo "<div class=\"normal\">\n";
echo "<h2>gettext(Knytt) $person $name gettext(til hendelse)</h2>\n";

echo "<form name=\"insert_event\" method=\"post\" action=\"./event_assoc_ack.php\">\n";
echo "<div><input type=\"hidden\" name=\"person\" value=\"$person\" />\n";
echo "<table>\n";

echo "<tr><td>gettext(Hovedperson?)</td><td>\n";
echo ("<input type=\"radio\" name=\"is_principal\" checked value=\"t\" /> Ja\n");
echo ("<input type=\"radio\" name=\"is_principal\" value=\"f\" /> Nei\n");
echo "</td></tr>\n";

echo "<tr><td>gettext(Hendelses-id:) </td><td><input type=\"text\" size=\"25\" name=\"event_id\" /></td></tr>\n";
echo "<tr><td>&nbsp;  </td><td><input type=\"submit\" value=\"gettext(Oppdater)\" /></td></tr>\n";
echo "</table>\n";
echo "</div>\n";
echo "</form>\n";
